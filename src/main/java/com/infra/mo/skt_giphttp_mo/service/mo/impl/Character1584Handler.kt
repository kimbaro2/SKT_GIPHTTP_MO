...
/**
 * 2. 1584 캐릭터문자 — handle()에서 흐름 전부 구현. InsqStat·DB Insert(1584 entity 재조회 후 insertGIPMOCallInfo) 등은 handle() 내부에서 호출.
 * MOTRBILL 체크 후 MO-TR 위임.
 */
@Component
class Character1584Handler(
    ...
    override fun serviceType(): MoServiceType = MoServiceType.CHARACTER_1584
