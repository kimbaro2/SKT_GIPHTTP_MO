...
/**
 * 4. 2580 문자매신저 — handle()에서 흐름 전부 구현. InsqStat·DB Insert(insertGIPMOCallInfo) 등은 handle() 내부에서 호출.
 * recordMoSuccessInsqStat/recordMoAckBilling은 로그만. MOTRBILL 체크 후 MO-TR 위임.
 */
@Component
class SmsMessenger2580Handler(
    ...
    override fun serviceType(): MoServiceType = MoServiceType.SMS_MESSENGER_2580
